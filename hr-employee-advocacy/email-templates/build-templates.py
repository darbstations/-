...
TEMPLATES = [
    ...
    # ── T-09 · شكر متقاطع بين إدارتين ──
    ("09-cross-department-thanks.html", {
        "subject": "{{DEPT_FROM}} تشكر {{FIRST_NAME}} من {{DEPT_TO}}",
        "preheader": "شهادة من إدارة استفادت فعلًا، لا مجاملة.",
        "unit": "الموارد البشرية",
        "band": "أخبار",
        "band_label": "ترشيح متقاطع",
        "headline": "شكر من إدارة أخرى",
        "body": [
            ("p", "{{FIRST_NAME}}،"),
            ("p", "وصلَنا ترشيح باسمك من <b>{{DEPT_FROM}}</b>."),
            ("p", "نحب نوقف عند نقطة: هذا الترشيح ما جاء من مديرك، جاء من إدارة ثانية استفادت من شغلك. وهذي أصدق شهادة يقدر يحصل عليها موظف مكتبي — لأن الشغل المكتبي الجيد عادة ما يشوفه أحد إلا اللي انتفع منه."),
            ("m", "نسخة من هذي الرسالة وصلت {{MANAGER_NAME}} ومدير إدارتك، وانضافت لملفك المهني."),
        ],
        "box": ("نص الترشيح كما كتبوه", "«{{NOMINATION_TEXT}}»<br><br>— {{NOMINATOR_NAME}}، {{DEPT_FROM}}"),
        "cta": None,
        "sign": HR,
    }),

    # ── T-10 · تقدير خدمة الميدان ──
    ("10-field-service-recognition.html", {
        "subject": "محطة {{STATION}} ترشّحك، {{FIRST_NAME}}",
        "preheader": "الميدان لاحظ شغلك — وهذا نادر.",
        "unit": "الموارد البشرية",
        "band": "تقدير",
        "band_label": "خدمة الميدان",
        "headline": "الميدان يشكرك",
        "body": [
            ("p", "{{FIRST_NAME}}،"),
            ("p", "ترشيحك ما جاء من المقر. جاء من <b>{{STATION}}</b>."),
            ("p", "في درب نقيس الإدارات المكتبية بمقياس واحد قبل أي مقياس: هل سهّلت على المحطة أو عقّدت عليها؟ وأنت هالمرة سهّلت."),
            ("m", "المحطة اللي شغلها ماشي بسبب استجابتك تخدم يوميًا مئات العملاء. أثرك وصلهم وإن ما شفتهم."),
        ],
        "box": ("ما كتبته المحطة", "«{{NOMINATION_TEXT}}»<br><br>— {{NOMINATOR_NAME}}، {{STATION}}"),
        "cta": None,
        "sign": HR,
    }),

    # ── T-11 · نجم المكاتب ──
    ("11-office-star-of-the-month.html", {
        "subject": "نجم المكاتب لشهر {{MONTH}}: {{STAR_NAME}}",
        "preheader": "{{DEPARTMENT}} — والسبب بالتفصيل.",
        "unit": "الموارد البشرية",
        "band": "تقدير",
        "band_label": "نجم المكاتب",
        "headline": "نجم المكاتب — {{MONTH}}",
        "body": [
            ("p", "زملاء درب،"),
            ("p", "نجم المكاتب لهذا الشهر: <b>{{STAR_NAME}}</b> — {{STAR_ROLE}}، إدارة {{DEPARTMENT}}."),
            ("p", "قبل السبب، جملة مهمة: تكريم موظف مكتبي أصعب من تكريم موظف محطة، لأن شغل المكتب ما له مشهد يُروى. علشان كذا نكتب السبب بالتفصيل — عشان يُرى."),
            ("p", "<b>ما الذي فعله</b>"),
            ("ul", ["{{REASON_1}}", "{{REASON_2}}", "{{REASON_3}}"]),
            ("p", "<b>من استفاد:</b> {{WHO_BENEFITED}}"),
            ("p", "{{STAR_FIRST_NAME}}، مبروك. التكريم: {{REWARD}}."),
            ("m", "ولبقية الزملاء: إذا إدارة ثانية سهّلت عليك شغلك هذا الشهر، رشّح صاحبها. الترشيح المتقاطع مفتوح للجميع، وما يحتاج إذن مديرك."),
        ],
        "box": None,
        "cta": ("{{CTA_URL}}", "رشّح زميلًا من إدارة أخرى"),
        "sign": HR,
    }),

    # ── T-12 · إدارة تعرّف بنفسها ──
    ("12-department-spotlight.html", {
        "subject": "تعرّف على {{DEPARTMENT}} — وش تسوي بالضبط",
        "preheader": "ومتى المفروض تتواصل معهم.",
        "unit": "{{DEPARTMENT}}",
        "band": "أخبار",
        "band_label": "دليل الإدارات",
        "headline": "تعرّف على {{DEPARTMENT}}",
        "body": [
            ("p", "زملاء درب،"),
            ("p", "هذا الشهر نفتح باب إدارة <b>{{DEPARTMENT}}</b>: {{TEAM_SIZE}} زميلًا، يقودهم {{DEPT_HEAD}}."),
            ("p", "<b>وش نسوي فعلًا</b>"),
            ("ul", ["{{WHAT_WE_DO_1}}", "{{WHAT_WE_DO_2}}", "{{WHAT_WE_DO_3}}"]),
            ("p", "<b>متى ما نكون الجهة الصحيحة</b><br>{{WHEN_NOT_US}} — بهذي الحالة توجّه لـ{{RIGHT_DEPT}} مباشرة وتوفّر على نفسك أسبوعًا."),
            ("m", "<b>شيء ما تعرفونه عنّا:</b> {{SURPRISING_FACT}}"),
        ],
        "box": ("متى تتواصل معنا وكيف", "{{WHEN_TO_CONTACT}}<br><br>أسرع طريقة: {{CONTACT_CHANNEL}} — ونرد خلال {{SLA}}."),
        "cta": ("{{CTA_URL}}", "دليل الإدارات الكامل"),
        "sign": ("{{AMBASSADOR_NAME}}", "سفير إدارة {{DEPARTMENT}}"),
    }),

    # ── T-13 · استبيان العميل الداخلي ──
    ("13-internal-customer-survey.html", {
        "subject": "٣ أسئلة عن الإدارات اللي تتعامل معها",
        "preheader": "دقيقتان — والنتائج تُنشر بالكامل.",
        "unit": "الموارد البشرية",
        "band": "مناسبة",
        "band_label": "استبيان داخلي",
        "headline": "صوتك عن الإدارات",
        "body": [
            ("p", "{{FIRST_NAME}}،"),
            ("p", "ثلاثة أسئلة، دقيقتان، وبدون اسمك. السؤال هو: الإدارات اللي تعاملت معها هذا الربع — كيف كانت؟"),
            ("p", "<b>ليش نسأل:</b> لأن كل إدارة في درب لها عميل داخلي، ومن غير المنطقي نقيس رضا العميل في المحطة ولا نقيس رضاك أنت."),
            ("m", "<b>وعدنا:</b> النتائج تُنشر كاملة على الجميع — بالجيد والسيئ — مع خطة الإدارات اللي جاءت أقل من المتوقع. استبيان تختفي نتائجه لا يستحق دقيقتين من وقتك، ونعرف ذلك."),
        ],
        "box": ("الأسئلة الثلاثة", "هل وصلك رد في وقت معقول؟<br>هل التزموا بالوعد اللي أعطوك إياه؟<br>وش الشي الوحيد اللي لو تغيّر يسهّل شغلك؟"),
        "cta": ("{{CTA_URL}}", "ابدأ الاستبيان"),
        "sign": HR,
    }),
]
