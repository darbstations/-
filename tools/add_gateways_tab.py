...
ACH = {"MK007": 95, "MK017": 103, "MK002": 36, "MK023": 97, "MK019": 36}
...
PANE = (
    ...
    '<div class="leg">36٪ · 36٪</div></div>'
    '<p style="font-size:12.5px;color:var(--ink2);line-height:1.85;margin-top:6px">'
    '<b>المعيصم وعرفات الشرايع</b> — المحطتان الوحيدتان عند <b>36٪ إنجاز</b> — كلتاهما في '
    'المنفذ الشرقي. أما <b>العمرة النورية 95٪</b> و<b>عرفات الشوقية 103٪</b> فتقعان في '
